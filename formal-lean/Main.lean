...
def printBalanceHypothesis : IO Unit := do
  ...
  IO.println "  The directed sign choice is the sole observer-motivated input:"
  IO.println "  it reflects the sector asymmetry of our universe (Re<0 dissipates, Im>0 oscillates)."
...
private def printNumericalAlignmentsSec12 : IO Unit := do
  ...
  IO.println "  for an observer using directed balance (−Re = +Im) and coherence"
  IO.println "  C(r) = 2r/(1+r²).  The directed balance is the sole observer-motivated"
  IO.println "  input; all further structure follows as arithmetic necessity."
  ...
  IO.println ""
  IO.println "  The directed sign choice (−Re = +Im) is the sole observer-motivated"
  IO.println "  input.  The arithmetic consequences are unique and machine-checked."
  IO.println ""
