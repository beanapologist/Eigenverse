...
def printAlphaCheck : IO Unit := do
  ...
  IO.println "         = Z + (Float.log Z / Z) · (1 + FK/Z − FS/Z²)"
  ...
  IO.println "         9-term Taylor partial sum ∑_{k=0}^{8} 5^k/k! ≈ 138.307 > 137."
  IO.println ""
  ...
  IO.println "         Float eval: ≈ 137.036 (CODATA 2022: 137.035999177, error 2×10⁻⁹)."
  IO.println ""
