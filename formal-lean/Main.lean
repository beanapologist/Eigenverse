...
private def printEmpiricalSelfMeasurement : IO Unit := do
  ...
  IO.println "       model α_FS = 1/137 ≈ 0.00729927"
  IO.println "       CODATA 2018 α ≈ 0.00729735"
  IO.println "       |Δα| ≈ 1.9×10⁻⁶"
  IO.println ""
  IO.println "  [M2] V_Z closure at Z = 137 using measured α"
  IO.println "       137·α_CODATA ≈ 0.9997373"
  IO.println "       miss from exact unit closure ≈ 2.63×10⁻⁴"
  ...
  IO.println "       CODATA 2018 R ≈ 1836.15267"
  IO.println "       |ΔR| ≈ 0.153"
  IO.println ""
