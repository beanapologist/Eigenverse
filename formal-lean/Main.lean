...
def printChemicalBonds : IO Unit := do
  ...
  IO.println "    Dissociation limit: as R → ∞, electron-cloud overlap vanishes."
  IO.println "      lim_{R→∞} Im⟨(molecularHamiltonian R) ψ, ψ⟩ = 0"
  IO.println "    Once Im = 0, IsTunnelFunnelBoundState is False → bond broken."
