...
def printChemicalBonds : IO Unit := do
  ...
  IO.println ""
  IO.println "  Scope: This module formalizes Eigenverse model conditions associated"
  IO.println "  with bond stability.  It does NOT prove the hypothesis from"
  IO.println "  first-principles QM, which would require a Hilbert space, a"
  IO.println "  self-adjoint Hamiltonian operator, normalised wavefunctions,"
  IO.println "  the Rayleigh-Ritz theorem, and a two-centre molecular Hamiltonian."
  IO.println ""
  ...
  IO.println "  [11] chem_bond_maximum_coherence           : C(1) = 1  (calculus)"
  IO.println "  [12] chem_off_balance_coherence_reduced    : C(r) < 1 for r≠1  (calculus)"
  ...
  IO.println "20 theorems — all machine-checked, zero sorry."
  IO.println ""
  IO.println "See ChemicalBonds.lean module header for complete scope statement."
  IO.println ""
