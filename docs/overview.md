...
| **Particles** | Electron/Proton/Quark structures; mass, charge, spin, colorCharge; quark flavor hierarchy; baryon composition (uud/udd); hydrogen atom neutrality | 20 |
| **Total** | | **606** |
...
├── Particles.lean              # Electron, Proton, Quark; baryon composition (20)
...
├── particles/ElementaryParticles.lean  # Elementary particle module
